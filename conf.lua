...
function love.conf(t)
    ...
    t.identity = "vectorPhysics"  -- The name of the save directory (string)
    ...
    t.window.title = "nopan-studio"       -- The window title (string)
    ...
    t.window.depth = 5           -- The number of bits per sample in the depth buffer
    t.window.stencil = 5                -- The number of bits per sample in the stencil buffer
